  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative overflow-hidden">
        {/* Subtle background gradient - contained to prevent horizontal scroll */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-20 left-1/4 h-96 w-96 max-w-[50vw] rounded-full bg-path-vertical/5 blur-3xl" />
          <div className="absolute bottom-20 right-1/4 h-[500px] w-[500px] max-w-[50vw] rounded-full bg-path-content/5 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollReveal>
            <div className="mx-auto max-w-2xl text-center mb-16">
              ...
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                From uncertainty to clarity - see the path and feel ready to act
              </p>
            </div>
          </ScrollReveal>
