    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="text-center py-12" role="alert">
          ...
          <button
            onClick={() => refetch()}
            className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 min-h-[44px]"
          >
            Try Again
          </button>
        </div>
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => refetch()}
            disabled={isFetching}
            aria-label={isFetching ? 'Refreshing analytics' : 'Refresh analytics'}
            className="p-2 rounded-lg hover:bg-muted transition-colors disabled:opacity-50 min-h-[44px] min-w-[44px]"
          >
            <RefreshCw
